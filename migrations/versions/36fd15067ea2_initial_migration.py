...
Revision ID: 36fd15067ea2
Revises: 
Create Date: 2025-02-10 08:52:44.177788
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('estado', sa.Enum('iniciada', 'recepcionada', 'en_progreso', 'finalizada', 'rechazada', 'reasignada', 'enviada', 'archivado', name='estadoderivacionenum'), nullable=False),
    sa.Column('comentario', sa.Text(), nullable=True),
    sa.Column('fecha', sa.TIMESTAMP(), nullable=True),
    sa.Column('recepcionada', sa.Boolean(), nullable=True),
    sa.Column('usuario_id', sa.Integer(), nullable=True),
    sa.Column('derivacion_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['derivacion_id'], ['derivaciones.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
