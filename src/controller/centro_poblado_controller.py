...
@router.post("/centros_poblados", response_model=CentroPobladoResponse, description="Crea un nuevo centro poblado")
...
@router.get("/centros_poblados", response_model=List[CentroPobladoResponse], description="Obtiene todos los centros poblados")
...
@router.put("/centros_poblados/{centro_poblado_id}", response_model=CentroPobladoResponse, description="Actualiza un centro poblado")
...
@router.delete("/centros_poblados/{centro_poblado_id}", description="Elimina un centro poblado")
...
@router.get("/centros_poblados/search", response_model=List[CentroPobladoResponse], description="Busca centros poblados por cadena de búsqueda")
...
@router.get("/centros_poblados/paginated", response_model=PaginatedResponse, description="Obtiene los centros poblados paginados")
async def get_paginated_centros_poblados(
    ...
    try:
        return centro_poblado_service.get_all_centros_poblados_paginated(page, per_page)
    except HTTPException as e:
        raise