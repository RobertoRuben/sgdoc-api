...
class DocumentoUpdateRequest(BaseModel):
    ...
    caserio_id: Optional[int] = Field(None, description="El id del caserío debe ser mayor a cero", ge=1)
    centro_poblado_id: Optional[int] = Field(None, description="El id del centro poblado debe ser mayor a cero", ge=1)
