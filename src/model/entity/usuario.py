...
if TYPE_CHECKING:
    from src.model.entity import Rol,Trabajador, Derivacion
...
class Usuario(SQLModel, table=True):
    ...
    fecha_actualizacion: datetime | None = Field(sa_column=Column(TIMESTAMP, default=datetime.now, onupdate=datetime.now))
